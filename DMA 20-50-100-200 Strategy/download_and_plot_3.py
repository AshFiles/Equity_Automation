...
4. **Visualization:**
   ...
   - **Optional:** Displays the plot window based on user input.
...
### Example Commands:
- **Run for UNIONBANK (default) with graph:**
  ```bash
  python script.py
...
def main():
   ...
   # -------------------------------
   analysis_years = 5  # Set the number of years for analysis (e.g., 5, 10)
